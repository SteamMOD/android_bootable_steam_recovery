...
// device specific code gets here
#ifndef __RECOVERY_DEVICE_H
#define __RECOVERY_DEVICE_H
...
extern const char g_mmc_device[];
extern const char g_raw[];
